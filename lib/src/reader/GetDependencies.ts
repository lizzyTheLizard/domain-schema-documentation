import { type Definition, type InterfaceDefinition, type Property } from '../schemaNormalizer/NormalizedSchema'
import { type Model, type PropertyExtension, type Schema } from './Reader'
